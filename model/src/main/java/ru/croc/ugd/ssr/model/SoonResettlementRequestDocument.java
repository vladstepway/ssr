...
@Getter
@Setter
public class SoonResettlementRequestDocument extends DocumentAbstract<SoonResettlementRequest> {

    @Nonnull
    @JsonProperty("SoonResettlementRequest")  //должно соответствовать корневому элементу XSD
    private SoonResettlementRequest document;
