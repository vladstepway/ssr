 ...
 *         &lt;element name="BirthPlace" type="{http://common.kvs.pfr.com/1.0.0}BirthPlaceType" minOccurs="0"/>
...
@XmlRootElement(name = "SnilsByAdditionalDataResponse", namespace = "http://kvs.pfr.com/snils-by-additionalData/1.0.1")
public class SnilsByAdditionalDataResponse {
    ...
    @XmlElement(name = "Snils", namespace = "http://kvs.pfr.com/snils-by-additionalData/1.0.1", required = true)
