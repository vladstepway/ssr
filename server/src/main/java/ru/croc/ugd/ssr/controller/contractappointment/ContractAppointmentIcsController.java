...
@RestController
@AllArgsConstructor
public class ContractAppointmentIcsController {
     ...
     */
    @GetMapping(value = "/contract-appointment/{id}/ics")
    public ResponseEntity<byte[]> getIcsFileContent(@PathVariable("id") final String id) {
        final byte[] icsFileContent = restContractAppointmentService.getIcsFileContent(id);
