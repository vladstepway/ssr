...
/**
 * Контроллер рабочих дней ЦИП для расписания осмотров квартир.
 */
@RestController
@AllArgsConstructor
@RequestMapping("/internal/flat-appointments/schedule")
public class FlatAppointmentDayScheduleController {

    private final RestDayScheduleService<FlatAppointmentDayScheduleDocument> restDayScheduleService;
