...
/**
 * Обработчик сообщений ПСО типа "ugd_v6_responseBRFinal".
 */
@Component
public class ResponseBrFinalRequestProcessorV6 implements MessageProcessor {

    @Nonnull
    @Override
    public String getMessageType() {
        return "ugd_v6_responseBRFinal";
    }
