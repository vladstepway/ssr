...
/**
 * Информация о регистрации договора.
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class ContractRegisterListener extends EtpQueueListener<SendTasksMessage, CoordinateTaskData> {
    ...
    public String getMessageType() {
        return mqetpmvProperties.getContractRegisterMessageType();
    }
    ...
    public IntegrationFlowType getIntegrationFlowType() {
        return IntegrationFlowType.DGI_TO_DGP_CONTRACT_REGISTER;
    }
