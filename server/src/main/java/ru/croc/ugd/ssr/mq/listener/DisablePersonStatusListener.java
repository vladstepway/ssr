...
@Component
@AllArgsConstructor
public class DisablePersonStatusListener implements EtpMessageListener {
    ...
    public String getMessageType() {
        return mqetpmvProperties.getDisabledPersonFlowStatusIncMessageType();
    }
    ...
    public void receiveMessage(@NotNull final String messageType, @NotNull final EtpInboundMessage etpInboundMessage) {
        ssrMqetpmvFlowService.receiveFlowStatusMessage(
            ...
            integrationProperties.getXmlImportDisabledPerson()
        );
    }
}
